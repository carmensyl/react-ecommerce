...
const stripePromise = loadStripe(
  "pk_test_51N5AmpKb78q3bJ6oKOHNQzp9xc8cY2JptmWElorFpkdDTK80p1m1AIeXOoJOqb4w2MZsriBPjqVsK18J6DEUk0h000NYGKsKcD"
)
  ...
  return (
    <div className="flex flex-col items-center pb-10">
      <Head>
        ...
        <meta property="og:title" content=" ECommerce - Checkpit" key="title" />
      </Head>
      <div
        className="
                ...
                <div className="mt-4 border-t pt-10">
                  <form onSubmit={handleSubmit}>
                    ...
                    <button
                      ...
                      className="hidden md:block bg-blue-600 hover:bg-black text-white font-bold py-2 px-4 mt-4 rounded focus:outline-none focus:shadow-outline"
                      // type="button"
                    >
                      Confirm order
                    </button>
